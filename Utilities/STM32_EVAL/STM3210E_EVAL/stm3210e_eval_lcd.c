...
/*******************************************************************************
* Function Name  : ili9320_SetPixelIndex
* Description    : Draws a pixel on LCD.
* Input          : - Xpos: the X position where to display the pixel.
*                  - Ypos: the Y position where to display the pixel
*                  - c: pointer to the pixel.
* Output         : None
* Return         : None
*******************************************************************************/
void ili9320_SetPixelIndex(uint16_t Xpos, uint16_t Ypos, uint16_t c)
{
...
/*******************************************************************************
* Function Name  : ili9320_GetPixelIndex
* Description    : Draws a pixel on LCD.
* Input          : - Xpos: the X position of the pixel.
*                  - Ypos: the Y position of the pixel.                  
* Output         : - c: pointer to the pixel.
* Return         : None
*******************************************************************************/
uint16_t ili9320_GetPixelIndex(uint16_t Xpos, uint16_t Ypos)
{
  uint16_t c;
  LCD_SetCursor(Xpos, Ypos);
  c = LCD_ReadRAM(); 
  return(LCD_BGR2RGB(c));
}
/*******************************************************************************
* Function Name  : LCD_BGR2RGB
* Description    : convert a bgr pixel to rgb pixel.
* Input          : - c: pixel to be convert. 
* Output         : rgb data
* Return         : None
*******************************************************************************/
